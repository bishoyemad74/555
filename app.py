...
# CSS لإخفاء عناصر واجهة Streamlit + إجبار الكاميرا على استخدام العدسة الأساسية (Standard Rear Camera)
st.markdown(
    """
    <style>
        ...
        /* تحسين ضبط زاوية الكاميرا للتركيز على العدسة الأساسية بدلاً من الوايد انجل */
        video {
